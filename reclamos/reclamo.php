...
<body class="page-specific">
    ...
    <div class="footer-responsive">
      <a href="https://api.whatsapp.com/send?phone=3416530650&text=Hola, tengo una consulta:"
      target="_blank">
      <i><svg
        class="icon-whatsapp"
      ...
      <a href="https://www.instagram.com/fornax.cocinas/" target="_blank"
          >
          <i><svg
            class="icon-whatsapp"
            xmlns="http://www.w3.org/2000/svg"
        ...
        ></i></a>
        <a href="https://www.facebook.com/Fornax.Cocinas/" target="_blank"
          >
          <i><svg
            class="icon-whatsapp"
            xmlns="http://www.w3.org/2000/svg"
