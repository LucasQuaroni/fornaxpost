...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-11-2023 a las 06:55:56
...
(20, 3, 'R', 'Alvear 12', '1-asignada', '', 91),
(21, 4, 'D', 'Alvear 12', '3-completada', 'Listo.', 91);
...
(91, '44765283', '2023-11-08', '777777', 'La cocina perdió las perillas, se descascararon y desintegraron.', 'FIN', 1);
...
--
ALTER TABLE `servicios`
  MODIFY `idserviciotecnico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
